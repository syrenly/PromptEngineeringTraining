...
# SCALAR BROADCASTING
print(arr+2) # creates a new array [2 2 2 2 2] which is summed to the first one => [3 4 5 6 7]; this is called SCALAR BROADCASTING+VECTORIZATION
...
try:
    print(B+C) # ko => ValueError: operands could not be broadcast together with shapes (3,) (2,) 
except ValueError:
